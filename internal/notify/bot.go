...
const helpText = "Привет!\n\n" +
	"Я присылаю уведомления, когда твоё расписание на my.sibsutis.ru " +
	"меняется (отмена пары, перенос аудитории, замена преподавателя).\n\n" +
	"Чтобы подписаться:\n" +
	"1. Открой сайт sibsutis-schedule и найди своё расписание;\n" +
	"2. Нажми «Подписаться на изменения» — откроется этот чат с готовой подпиской.\n\n" +
	"Команды:\n" +
	"/list — твои подписки\n" +
